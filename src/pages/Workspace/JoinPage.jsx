      ...
      <div className='flex flex-col gap-y-4 items-center justify-center'>
        ...
        <VerificationInput
          ...
          classNames={{
            ...
            character:
              'h-auto rounded-md flex items-center justify-center border border-gray-300 text-lg font-medium focus:outline-none focus:border-blue-500 focus:ring-blue-500',
